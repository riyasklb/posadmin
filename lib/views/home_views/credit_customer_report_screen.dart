...
class CreditCustomerReportscreen extends StatefulWidget {
  const CreditCustomerReportscreen({super.key});

  @override
  State<CreditCustomerReportscreen> createState() => _CreditCustomerReportscreenState();
}

class _CreditCustomerReportscreenState extends State<CreditCustomerReportscreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(
        ...
        title:const Text("Credit Customer",style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: [
          InkWell(
            onTap: (){
