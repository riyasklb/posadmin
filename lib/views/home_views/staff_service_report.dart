...
class StaffServiceReport extends StatefulWidget {
  const StaffServiceReport({super.key});

  @override
  State<StaffServiceReport> createState() => _StaffServiceReportState();
}

class _StaffServiceReportState extends State<StaffServiceReport> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(
        ...
        title:const Text("Staff Service Report",style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: [
          InkWell(
            onTap: (){
